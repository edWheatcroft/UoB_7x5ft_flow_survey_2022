...
arguments
    ...
    F = {};
    for i = 1:3
        tmp_res = farg.struct.filter(final_data,{{'U_inf',{'tol',Vs(i),1.5}}});
        y = [tmp_res.y]';
        z = [tmp_res.z]';
        us = [tmp_res.U]';
    ...
    V = scatteredInterpolant(Ys,Zs,Us',opts.Method,opts.Extrap);
    Pitch = scatteredInterpolant(Ys,Zs,pitchs',opts.Method,opts.Extrap);
    Yaw = scatteredInterpolant(Ys,Zs,yaws',opts.Method,opts.Extrap);
end